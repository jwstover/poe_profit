defmodule PoeProfitWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PoeProfitWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PoeProfitWeb.Gettext, "errors", msg, opts)
    end
  end
